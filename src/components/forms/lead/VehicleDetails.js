...
import { getMakeData, getModelData, saveLeadData } from "src/api/services/lead";
...
const VehicleDetails = (props) => {
  ...
  const [modelList, setModelList] = useState(
    props.vehicleInitialData.modelList ? props.vehicleInitialData.modelList : []
  );
    ...
    <Card bordered hoverable>
      ...
      <Form
        ...
        initialValues={{
          ...
          vehicle_type: props.vehicleInitialData.vehicle_type
            ? props.vehicleInitialData.vehicle_type
            : "Bike",
        }}
        size="large"
      >
        ...
        >
          <Radio.Group optionType="button" buttonStyle="solid" size="large">
            <Radio.Button value="7" style={{ width: 90 }}>
              7 Days
            </Radio.Button>
            <Radio.Button value="15" style={{ width: 90 }}>
              15 Days
            </Radio.Button>
            <Radio.Button value="30" style={{ width: 120 }}>
              30 Days
            </Radio.Button>
            <Radio.Button value="45" style={{ width: 90 }}>
              45 Days
            </Radio.Button>
            <Radio.Button value="60" style={{ width: 90 }}>
              60 Days
            </Radio.Button>
            <Radio.Button value="JC" style={{ width: 120 }}>
              JustChecking
            </Radio.Button>
          </Radio.Group>
        </Form.Item>
